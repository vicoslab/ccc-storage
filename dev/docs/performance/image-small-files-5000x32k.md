...
- Result root: `/storage/user/ccc-storage-image-dev/bench/runs/donbot-20260630T100156Z-14437`

## Mounts

- `/dev/bench/nfs`: `/dev/bench/nfs 10.10.20.31:/nfs/LUVSS_home/vicos/<ccc-user-id>/ccc-storage-image-dev/bench/runs/donbot-20260630T100156Z-14437/nfs nfs4 rw,relatime,vers=4.0,rsize=1048576,wsize=1048576,namlen=255,hard,proto=tcp,timeo=600,retrans=2,sec=sys,clientaddr=10.10.20.75,fsc,local_lock=none,addr=10.10.20.31`
- `/dev/bench/ssd`: `/dev/bench/ssd /dev/md0[/opt/storage/ssd/<ccc-user-id>/ccc-storage-image-dev/bench/runs/donbot-20260630T100156Z-14437/ssd] ext4 rw,relatime,stripe=256`
