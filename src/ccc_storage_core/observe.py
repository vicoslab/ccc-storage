...
Any directory containing ``CCC_STORAGE_OBSERVE`` is an observation root. Every
...
from ccc_storage_core.manifest import normalize_write_policy

OBSERVE_MARKER_NAME = "CCC_STORAGE_OBSERVE"
